	...
	<input type="hidden" name="method" value="add">
		<table width="95%" align="center" cellpadding="0" cellspacing="0">
			...
			<tr align="center">
				...
				<td>
					<a class="jian" id="12345Jian"></a>${cartItem.quantity}<a class="jia" id="12345Jia"></a>
				</td>
				<td width="100px">
					<span class="price_n">&yen;<span class="subTotal" id="12345Subtotal">${cartItem.subtotal}</span></span>
				</td>
				<td>
					<a href="<c:url value="/CartServlet?method=delete&bid=${cartItem.book.bid}"/>">删除</a>
				</td>
			</tr>
			...
			<tr>
				收货地址：<input name="address" value="北京市 昌平区 西三旗 金燕龙办公楼1层 传智播客 张三爷"/>
			</tr>
			...
			<tr>
				...
				<td colspan="3" align="right" class="tdTotal">
					<span>总计：</span><span class="price_t">&yen;${sessionScope.session_cart.total}</span>
				</td>
			</tr>
			<tr>
				<td colspan="7" align="right">
					<input type="submit" name="jiesuan" value="结算">
				</td>
			</tr>
		</table>
</form>
